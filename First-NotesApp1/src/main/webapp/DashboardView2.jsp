...
<body>
       ...
       <section>
	       <div id="search-note" class="content">
	            ...
	            <form action="notes" method="get">
	                <input type="text" id="search-query" name="keyword" placeholder="Enter keyword or title" required>
    ...
    <%
        List<Note> notess = (List<Note>) request.getAttribute("notes");
        if (notess == null || notess.isEmpty()) {
